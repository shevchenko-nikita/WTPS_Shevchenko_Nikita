...
export function updateTopteachersGrid(teachersToDisplay) {
    ...
    if (teachersToDisplay !== undefined) {
        filteredTeachers = filterUsers(teachersToDisplay, region, age1, age2, gender, onlyFavorite, onlyWithPhoto);
    } else {
        filteredTeachers = filterUsers(teachers, region, age1, age2, gender, onlyFavorite, onlyWithPhoto);
    }
